...
const { invalidateItemShopCache } = require("./functions.js");
...
const getChapterLimit = () => config.bChapterlimit || "1";
const getSeasonLimit = () => config.bSeasonlimit || "10";
const getDailyItemsAmount = () => config.bDailyItemsAmount || 6;
const getFeaturedItemsAmount = () => config.bFeaturedItemsAmount || 2;
...
(async () => {
    if (config.bUseCustomShopDate === true) {
